function f = pbmindex(X, clrs, varargin)
% PBMINDEX Evaluation based on the PBM criterion.
%   PBMINDEX(X, CLUST) computes the PBM criterion 
...
%
%   V = PBMINDEX(X, CLUST) returns a positive numeric value corresponding to
...
Xmean = mean(X,1)'; % Media global de los datos
